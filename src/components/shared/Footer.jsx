      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <form  className="flex max-w-sm mt-2">
              <input
                type="email"
                placeholder="Enter your email"
                className="w-full px-4 py-2 text-sm bg-slate-800 text-white rounded-l-md border border-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder-slate-500"
                required
              />
              <button
                type="submit"
          ...
          <div className="flex flex-col space-y-4 md:items-end">
            <div>
              <h3 className="text-sm font-semibold text-white tracking-wider uppercase mb-4 md:text-right">
                Connect With Us
              </h3>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 text-center md:flex md:justify-between md:text-left">
